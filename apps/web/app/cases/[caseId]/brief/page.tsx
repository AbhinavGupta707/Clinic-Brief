    ...
    <AppShell eyebrow={`Case ${caseId}`} title={brief.title}>
            ...
            <Link
              ...
              className={`flex min-h-11 items-center justify-center rounded-md border px-3 py-2 text-center text-sm font-semibold transition ${
                isSelected
                  ...
                  : "border-clinic-line bg-white text-clinic-ink hover:bg-cyan-50"
              }`}
      ...
      <div className="grid gap-5 lg:grid-cols-[1fr_22rem]">
        <article className="clinic-print-page grid gap-5 rounded-md border border-clinic-line bg-white p-5 shadow-soft">
          ...
          <BriefSection title="90-second story" icon={MessageSquareText}>
            <p>{brief.ninetySecondStory}</p>
          </BriefSection>

          <BriefSection title="Key timeline" icon={ClipboardList}>
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <BriefSection title="What changed" icon={FileText}>
              <BulletList items={brief.whatChangedSinceLastAppointment} />
            </BriefSection>
            <BriefSection title="Open uncertainties" icon={FileText}>
              <BulletList items={brief.openUncertainties} />
            </BriefSection>
          </div>

          <div className="grid gap-5 md:grid-cols-2">
            <BriefSection title="Allergies and important notes" icon={FileText}>
              <BulletList items={brief.allergiesAndImportantNotes} />
            </BriefSection>
            <BriefSection title="Questions for clinician" icon={ClipboardList}>
        ...
        <aside className="grid content-start gap-4">
          ...
          <section className="rounded-md border border-clinic-line bg-white p-5 shadow-soft">
            ...
            <pre className="mt-4 max-h-64 overflow-auto rounded-md bg-clinic-surface p-4 text-xs leading-5 text-clinic-ink">
              {markdown}
            </pre>
          </section>
